...
ES_ENDPOINT = 'search-XXXXX-XXXXXXXXXXX.us-east-1.es.amazonaws.com'
...
def post_data_to_es(payload, region, creds, host, path, method='POST', proto='https://'):
   ...
   testUrl = proto + host + urllib.parse.quote(path)
   
   print("failing at url: ",testUrl)
...
def _lambda_handler(event, context):
   ...
   for record in records:
       ...
       if (event_name == 'INSERT') or (event_name == 'MODIFY'):
           ...
           print("the deserialized fields: ", doc_fields)
           # Add metadata
